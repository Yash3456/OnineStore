  ...
  return (
    <div className="container__0">
      ...
      <div className="content-container">
        <p>
          Thank you for shopping with Amalgsoft Store! We want to ensure your
        ...
        <p>
          ...
          support@amalsoftstore.com
          <br />
          <span style={{ fontWeight: "500" }}>Phone  </span>:  123-456-7890
          <br />
      <span style={{ fontWeight: "500" }}>    Hours of Operation: Monday to Friday, 8:00 AM to 5:00 PM </span>
        </p>
        <p>
