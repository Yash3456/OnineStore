    ...
    <div className="privacy-policy-container">
     <MetaData title={"Privacy Policy"} />
      <div className="container___">
        <h1>Privacy Policy of Amalgsoft Store</h1>
        <p style={{ fontSize: "16px", fontWeight: "600" }}>
          {" "}
          Effective Date: 25-12-2023
        </p>
        <p>
          At Amalgsoft Store, we value the privacy of our customers and are
        ...
        <p>
          By using the Amalgsoft Store website and services, you agree to the
