  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with Amalgsoft Store! We appreciate your business
        ...
        <p>
          ...
          agreed to in writing by Amalgsoft Store.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to Amalgsoft Store's acceptance. We may refuse to
        ...
        <p>
          ...
          Amalgsoft Store. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock Amalgsoft Store products. We
        ...
        <p>
          ...
          taxes, except for those based on Amalgsoft Store's income. If
          Amalgsoft Store is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without Amalgsoft Store's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold Amalgsoft Store harmless from any
