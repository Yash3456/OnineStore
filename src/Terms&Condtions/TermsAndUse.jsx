    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, amalgsoftstore.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with Amalgsoft Store
          ...
          agreed to or set forth in writing by Amalgsoft Store, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to Amalgsoft Store's acceptance. This means
          Amalgsoft Store may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, Amalgsoft Store
        ...
        <p>
          ...
          and it is accepted by Amalgsoft Store. Prices for products displayed on
          ...
          website may differ from those in stores that stock Amalgsoft Store
          products, as these stores are independent of Amalgsoft Store.
          Amalgsoft Store reserves the right to amend pricing for any pricing
          ...
          submitted an online order, Amalgsoft Store will notify you of the error
        ...
        <p>
          ...
          Amalgsoft Store reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse Amalgsoft Store if it pays, any
          taxes, except for those based on Amalgsoft Store's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by Amalgsoft Store for when the
          ...
          are beyond our control. Amalgsoft Store cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by Amalgsoft Store, customer
          may not cancel such accepted order without Amalgsoft Store’s prior
          ...
          expenses. The product(s) must be returned to Amalgsoft Store within
        ...
        <p>
          ...
          all applicable laws in force in Uganda from time to time. The
        ...
        <p style={{ fontWeight: "500" }}>Amalgsoft Store</p>
        <p style={{ fontWeight: "500" }}>123 Main Street,Kamapala, Uganda</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@amalgsoftstore.com</span>
        </p>
      </div>
    </div>
  );
